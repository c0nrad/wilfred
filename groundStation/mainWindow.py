...
#
# Created: Wed Feb 20 11:46:33 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_11.setGeometry(QtCore.QRect(10, 20, 224, 124))
        self.groupBox_11.setObjectName(_fromUtf8("groupBox_11"))
        self.connectButton = QtGui.QPushButton(self.groupBox_11)
        self.connectButton.setGeometry(QtCore.QRect(138, 50, 75, 24))
        ...
        self.line_2.setGeometry(QtCore.QRect(120, 25, 16, 88))
        self.line_2.setFrameShape(QtGui.QFrame.VLine)
        self.line_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_2.setObjectName(_fromUtf8("line_2"))
        self.disconnectButton = QtGui.QPushButton(self.groupBox_11)
        self.disconnectButton.setGeometry(QtCore.QRect(140, 80, 75, 24))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget = QtGui.QWidget(self.groupBox_11)
        self.widget.setGeometry(QtCore.QRect(11, 25, 112, 88))
        ...
        self.ipAddressEdit = QtGui.QLineEdit(self.widget)
        ...
        self.portEdit = QtGui.QLineEdit(self.widget)
...
"font: 9pt \"Monospace\";"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ipAddressEdit.setText(_translate("MainWindow", "192.168.1.3", None))
        self.label_3.setText(_translate("MainWindow", "Port Number", None))
        self.portEdit.setText(_translate("MainWindow", "1337", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Connect", None))
